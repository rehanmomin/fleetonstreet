...
//process.env.SWEST_KEY = config.getKey()
process.env.BASE_URL = config.getBaseUrl(args.environment, "jarvisurl")
process.env.SIP_URL = config.getBaseUrl(args.environment, "sipui")
